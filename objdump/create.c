...
object_dump_t *create_object_dump(char *file_name)
{
    ...
    || (obj->sys_type = get_sys_type(obj->file_name, obj->buf)) == -1)
        return (NULL);
    if (obj->stats.st_size < ((Elf64_Ehdr *)obj->buf)->e_ehsize +
    (((Elf64_Ehdr *)obj->buf)->e_phnum * ((Elf64_Ehdr *)obj->buf)->e_phentsize)
    + (((Elf64_Ehdr *)obj->buf)->e_shnum
    * ((Elf64_Ehdr *)obj->buf)->e_shentsize)) {
